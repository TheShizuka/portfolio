<script>
import AboutMe from './AboutMe.svelte'; /* Import the AboutMe component */
...
<div class="index">
  ...
  <div class="banner">
    <img src="../images/banner-noise.webp" alt="Banner Description" class="banner-image">
  </div>
<div class="banner-phone">
    <img src="../images/banner-phone-noise.webp" alt="Banner Description" class="banner-image">
  </div>
<AboutMe />
<div class="title-container">
  ...
  <div class="image-row">
    {#each imageCards1 as { title, description, link, imgSrc, alt } (title)}
